...
public final class CsvServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.nexterdigitals.nextershop.pb.csv.Request,
      com.nexterdigitals.nextershop.pb.uploadedfile.UploadedFile> getGenerateMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "generate",
      requestType = com.nexterdigitals.nextershop.pb.csv.Request.class,
      responseType = com.nexterdigitals.nextershop.pb.uploadedfile.UploadedFile.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.nexterdigitals.nextershop.pb.csv.Request,
      com.nexterdigitals.nextershop.pb.uploadedfile.UploadedFile> getGenerateMethod() {
    io.grpc.MethodDescriptor<com.nexterdigitals.nextershop.pb.csv.Request, com.nexterdigitals.nextershop.pb.uploadedfile.UploadedFile> getGenerateMethod;
      ...
      synchronized (CsvServiceGrpc.class) {
        if ((getGenerateMethod = CsvServiceGrpc.getGenerateMethod) == null) {
          CsvServiceGrpc.getGenerateMethod = getGenerateMethod =
              io.grpc.MethodDescriptor.<com.nexterdigitals.nextershop.pb.csv.Request, com.nexterdigitals.nextershop.pb.uploadedfile.UploadedFile>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "generate"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.nexterdigitals.nextershop.pb.csv.Request.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.nexterdigitals.nextershop.pb.uploadedfile.UploadedFile.getDefaultInstance()))
  ...
  public static abstract class CsvServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void generate(com.nexterdigitals.nextershop.pb.csv.Request request,
        io.grpc.stub.StreamObserver<com.nexterdigitals.nextershop.pb.uploadedfile.UploadedFile> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                com.nexterdigitals.nextershop.pb.csv.Request,
                com.nexterdigitals.nextershop.pb.uploadedfile.UploadedFile>(
  ...
  public static final class CsvServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<CsvServiceBlockingStub> {
    ...
    /**
     */
    public com.nexterdigitals.nextershop.pb.uploadedfile.UploadedFile generate(com.nexterdigitals.nextershop.pb.csv.Request request) {
  ...
  public static final class CsvServiceFutureStub extends io.grpc.stub.AbstractFutureStub<CsvServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.nexterdigitals.nextershop.pb.uploadedfile.UploadedFile> generate(
        com.nexterdigitals.nextershop.pb.csv.Request request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GENERATE:
          serviceImpl.generate((com.nexterdigitals.nextershop.pb.csv.Request) request,
              (io.grpc.stub.StreamObserver<com.nexterdigitals.nextershop.pb.uploadedfile.UploadedFile>) responseObserver);
          break;
        default:
  ...
  private static abstract class CsvServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.nexterdigitals.nextershop.pb.csv.CsvProto.getDescriptor();
    }
